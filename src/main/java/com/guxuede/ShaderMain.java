...
public class ShaderMain extends ApplicationAdapter {
	...
	@Override
	public void create () {
		String vertexShader = Gdx.files.internal("data/test.vsh").readString();
		String fragmentShader = Gdx.files.internal("data/test.fsh").readString();;
	...
	public static void main (String[] args) throws Exception {
		new LwjglApplication(new ShaderMain());
	}
}
