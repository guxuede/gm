...
import com.guxuede.ShaderLesson2;
...
//        cfg.useGL30 = true;
    ...
    public void create() {
        ...
        String vertexShader = Gdx.files.internal("data/lesson3.vsh").readString();
        String fragmentShader = Gdx.files.internal("data/lesson3.fsh").readString();;
