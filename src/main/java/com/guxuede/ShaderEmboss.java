...
public class ShaderEmboss extends ApplicationAdapter {
	...
	@Override
	public void create () {
		String vertexShader = Gdx.files.internal("data/emboss.vsh").readString();
		String fragmentShader = Gdx.files.internal("data/emboss.fsh").readString();
	...
	public static void main (String[] args) throws Exception {
		new LwjglApplication(new ShaderEmboss());
	}
}
