...
/**
 * LibGDX port of ShaderLesson6_Normap, i.e. normal mapping in 2D games.
 * @author davedes
 */
public class ShaderLesson6_Normap extends ApplicationAdapter {
    ...
    public static void main(String[] args) {
        ...
        cfg.height = 480;
        cfg.resizable = false;
        new LwjglApplication(new ShaderLesson6_Normap(), cfg);
    }
    Texture bg;
    ...
    public void create() {
        ...
        rock = new Texture(Gdx.files.internal("data/Inside_A4.png"));
        rockNormals = new Texture(Gdx.files.internal("data/Inside_A4_n.png"));
