...
public class GpuShadows implements ApplicationListener {
    ...
    public void create() {
        ...
        final String VERT_SRC = Gdx.files.internal("data/cpushadows/pass.vert").readString();

        // renders occluders to 1D shadow map
        shadowMapShader = createShader(VERT_SRC, Gdx.files.internal("data/cpushadows/shadowMap.frag").readString());
        // samples 1D shadow map to create the blurred soft shadow
        shadowRenderShader = createShader(VERT_SRC, Gdx.files.internal("data/cpushadows/shadowRender.frag").readString());

        //the occluders
        casterSprites = new Texture("data/cpushadows/cat4.png");
        //the light sprite
        light = new Texture("data/cpushadows/light.png");
