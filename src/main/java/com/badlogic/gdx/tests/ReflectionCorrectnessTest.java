...
//		Class clazz = AbstractInterfaceStatic.class;
...
//		Class clazz = AbstractInterfaceStatic[].class;
//		Class componentClazz = AbstractInterfaceStatic.class;
//		Expectation e = new Expectation().mArray().mCompType(componentClazz);
//		doTest(clazz, e);
//	}
//
//	public void testCustomAnnotationClass () {
//		Class clazz = AbstractAnnotationStatic.class;
...
//		Class clazz = AbstractAnnotationStatic[].class;
//		Class componentClazz = AbstractAnnotationStatic.class;
//		Expectation e = new Expectation().mArray().mCompType(componentClazz);
//		doTest(clazz, e);
//	}
//
//	public void testCustomEnumClass () {
//		Class clazz = StaticEnum.class;
...
//		Class clazz = StaticEnum[].class;
//		Class componentClazz = StaticEnum.class;
//		Expectation e = new Expectation().mArray().mCompType(componentClazz);
//		doTest(clazz, e);
//	}
//
